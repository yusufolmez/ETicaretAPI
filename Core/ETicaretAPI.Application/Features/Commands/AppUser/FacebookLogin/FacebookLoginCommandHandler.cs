...
namespace ETicaretAPI.Application.Features.Commands.AppUser.FacebookLogin
{
    public class FacebookLoginCommandHandler : IRequestHandler<FacebookLoginCommandRequest, FacebookLoginCommandResponse>
    {
        ...
        public FacebookLoginCommandHandler(UserManager<U.AppUser> userManager, ITokenHandler tokenHandler, HttpClient httpClient, IConfiguration configuration)
        {
        ...
        {
            string clientId = _configuration["FacebookAuth:ClientId"];
            string clientSecret = _configuration["FacebookAuth:ClientSecret"];
